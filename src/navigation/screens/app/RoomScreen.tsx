            ...
            )}
            {
                ...
                <View marginH-10>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => {
                            const phone = encodeURIComponent('+40721066871')
                            const amount = encodeURIComponent('69')
                            const currency = encodeURIComponent('RON')
                            Linking.openURL(`revolut://app/payments?phone=${phone}&amount=${amount}&currency=${currency}`)
                        }}
                    >
                        <Text bodyL white bold>
                            Pay with
                        </Text>
                            <Image source={{uri:"https://logolook.net/wp-content/uploads/2024/01/Revolut-Logo.png"}} height={40} width={70} resizeMode={"contain"}/>
                    </TouchableOpacity>
                </View>
            }
            {(room?.owner ?? "") === uid && (
