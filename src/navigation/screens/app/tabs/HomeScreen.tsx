...
import { KHistoryCard } from "../../../../components";
  ...
  return (
    <KContainer>
      ...
      <View style={styles.historyCard}>
        <KHistoryCard roomId={passedRoom.length > 0 ? passedRoom[0].id : ""} />
      </View>
      <KSpacer h={300} />
