...
export const ScanScreen = () => {
    ...
    return (
        ...
        >
            ...
            <Modal isVisible={modalVisible} onBackdropPress={() => setIsModalVisible(false)}
                   style={{bottom: 10, justifyContent: "flex-end"}}>
                <View bg-white style={{borderRadius: 20}} padding-10>
                    <Text bodyXL semiBold lightBlue>Image to be processed:</Text>
                    <Text bodyS light grey>The image below will be used for your split. Please make sure that you
                        captured the bill, if not, redo the image.</Text>
                    <KSpacer h={15}/>
                    <Image
                        source={{uri: photo}}
                    ...
                    >
                        <Text white center bold bodyXL>Redo</Text>
                    </TouchableOpacity>
                    <KSpacer/>
                    <TouchableOpacity
                        onPress={()=>{
                    ...
                    >
                        <Text white center bold bodyXL>Continue</Text>
                    </TouchableOpacity>
                </View>
            </Modal>
        </CameraView>
